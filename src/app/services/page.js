const services = [
    {
        ...
        price: "$150+ per page",
        description:
            "Ideal for marketing pages, portfolios, and simple informational sites.",
...
You’re not getting a reskinned theme. You're getting a tailored, high-performance experience that looks sharp, loads fast, and feels intentional across all devices.`,
    ...
    },
    {
        ...
        price: "$400+ per page",
        description:
            "For tools like dashboards, blogs, booking systems, or portals.",
...
The result is fast, secure, and scalable, with the same attention to UX, speed, and clarity as my static builds.`,
    ...
    },
    {
        ...
        price: "$100+ per page",
        description:
            "Need just the design? You'll get ready-to-build Figma files.",
...
You'll get dev-ready files, structure, and layout guidance, no extra fluff or guesswork.`,
    ...
    },
    {
        ...
        description:
            "UX, performance, and structure audits to improve your site.",
        ...
        <section className="max-w-6xl w-full px-6 mx-auto py-20 space-y-20">
            <div className="mb-12">
                ...
                <p className="leading-relaxed mt-2 text-brand-grey max-w-3xl">
                    I don't use templates, page builders, or WordPress. Every
                    site is custom-built for speed, clarity, and responsiveness,
                    while focusing on your content and goals. Below are the
                    services I offer and how I approach each.
                </p>
            </div>
