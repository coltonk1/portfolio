            ...
            <div className="w-full max-w-7xl px-6 md:px-12 py-16 sm:py-32 md:py-32 flex flex-col lg:flex-row gap-12 items-center z-10">
                ...
                <div className="flex-1 flex flex-col gap-6 text-center md:text-left">
                    <h1 className="text-4xl sm:text-5xl font-bold !text-hero-color text-center w-full lg:text-left">
                        Hi, I'm{" "}
                        <b className="!text-hero-color">Colton Karaffa</b>
                    </h1>
                    <p className="text-lg !text-hero-color max-w-xl mx-auto md:mx-0 text-center w-full lg:text-left">
                        I design and build websites that look great, work on any
                        device, and help people get things done.
                    </p>
        ...
        <section className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
            <div className="mb-12 text-center sm:text-left">
                ...
                <p className="leading-relaxed mt-2">
                    A few of my own projects to show how I solve real problems
            ...
            <div className="w-full flex flex-col items-center gap-4 mt-24 text-center">
                <p className="text-base sm:text-lg text-brand-grey max-w-xl">
                    Explore more projects that showcase my skills in full-stack
                    development, backend systems, and applied machine learning.
                </p>
                <Button
                    variant={3}
                    href="/personal-projects"
    ...
    return (
        <section className="max-w-6xl w-full px-6">
            <div className="mb-12">
                ...
                <p className="leading-relaxed mt-2">
                    Websites and interfaces I've built and/or designed, with a
                    focus on clarity, usability, and purposeful visual design.
                </p>
            </div>
            <div className="flex flex-col md:flex-row gap-8 lg:gap-24">
            ...
            <div className="w-full flex flex-col items-center gap-2 mt-15 md:mt-24">
                ...
                <Button
                    variant={3}
                    href="/client-work"
                    text="Browse Full Design Portfolio"
                />
            </div>
        </section>
    );
...
const extras = [
    ...
    },
    {
        ...
        features: [
            ...
            "Optional in-depth code review ($200+)",
        ],
    },
    {
        id: "support",
        ...
        <section className="max-w-6xl mx-6">
            <div className="text-left mb-12">
                ...
                <p className="text-left max-w-3xl leading-relaxed">
                    I build responsive, fast-loading websites, whether you need
                    a simple landing page or a custom interactive experience.
                    Pricing is per page and scales with complexity.
                </p>
            </div>
    ...
    return (
        <section className="max-w-6xl w-full flex flex-col gap-4 px-6">
            <div className="mb-8">
                ...
                <p className="leading-relaxed mt-2">
                    Design, builds, audits, and ongoing support, all priced
                    upfront, with room for flexibility based on your needs.
                </p>
            </div>
            ...
            <div className="mt-16 flex flex-col gap-6 md:gap-4 w-full items-center">
                <p className="md:text-left text-center">
                    Want an exact quote? I'll send one after a quick chat about
                    your goals.
                </p>
                ...
                <p className="flex gap-1 items-center">
                    ...
                    <Button
                        variant={5}
                        text={"learn more about my pricing ->"}
                        href="/services"
                    />
                </p>
            </div>
    ...
    return (
        <section className="max-w-6xl flex flex-col gap-4 px-6">
            <div className="mb-8">
                ...
                <p className="leading-relaxed mt-2">
                    Your website is often the first impression potential
                    customers get, and it only takes seconds for them to decide
                    whether they'll stick around or leave. These numbers speak
                    for themselves:
                </p>
            </div>
            <div className="flex md:flex-row flex-col gap-8">
                <div className="rounded-2xl p-4 lg:p-8 flex-1 flex flex-col items-center gap-4 lg:gap-8 bg-linear-to-b from-brand-white to-brand-translucent-purple">
                    ...
                    <p className="opacity-80 leading-relaxed text-center">
                        People form an opinion about your site in 50
                        milliseconds. Outdated design? You've already lost them.
                    </p>
                </div>
                <div className="rounded-2xl p-4 md:p-8 flex-1 flex flex-col items-center gap-4 md:gap-8 bg-linear-to-b from-brand-white to-brand-translucent-purple">
                    ...
                    <p className="opacity-80 leading-relaxed text-center">
                        One-third of users bounce if your layout feels clunky or
                        old. Good design keeps them reading.
                    </p>
                </div>
                <div className="rounded-2xl p-4 md:p-8 flex-1 flex flex-col items-center gap-4 md:gap-8 bg-linear-to-b from-brand-white to-brand-translucent-purple">
                    <img
                    ...
                    <p className="opacity-80 leading-relaxed text-center">
                        A bad first impression kills trust. Most visitors never
    ...
    return (
        <section className="w-full max-w-6xl px-6 md:px-12 flex flex-col gap-6 items-center text-center">
            <div>
                ...
                <p className="leading-relaxed mt-2">
                    I'm currently booking a limited number of freelance
                    projects. If you need a full-stack developer, a designer, or
                    both, get in touch and let's talk about your goals.
                </p>
            </div>
            {/* Contact Links */}
